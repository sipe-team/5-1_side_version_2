...
# Week6 
## 진행한 내용 
* Tooltip의 동작방식 변경 및 WCAG 준수 : [Pr](https://github.com/sipe-team/side/pull/259)
## 개인 느낀점 (100자)
- 다른 미션들과 달리 사이퍼분들과 한 팀이 되어 협업하며 많이 배웠습니다. 모노레포 환경도 새로웠고, 사이프가 아니면 못했을 값진 경험이었습니다. 함께한 SIDE 동료분들 감사합니다.
